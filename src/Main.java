...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("The total of adding the ints of " + intOperandA + " and " + intOperandB + " is " + intSum);
        ...
        System.out.println("The total of adding the doubles of " + doubleOperandA + " and " + doubleOperandB + " is " + doubleSum);

        doubleProduct = doubleOperandA * doubleOperandB;
        System.out.println("The product of the doubles " + doubleOperandA + " and " + doubleOperandB + " is " + doubleProduct);
